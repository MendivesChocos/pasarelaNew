...
<!DOCTYPE html>
            	...
            	//var codigo = document.getElementById('#inputEmail1').value;
                 ...
                 var x = document.forms["myForm"]["code"].value;
                    ...
                    if(x===""){
                        ...
                        alert(" El codigo no es un numero  ");
                        $('#inputEmail1').focus();
                    }else if(validar(x)==false){
                        alert(" El codigo no es un numero  ");
                        $('#inputEmail1').focus();
                    }
            }
    ...
    <form  name="myForm" action='' method='POST' onsubmit= "return comprobar()"  > 
              ...
              <form class="form-horizontal">
                <div class="form-group">
                  <div class="col-xs-12">
                    ...
                    <input type="text" class="form-control" id="inputEmail1" name="code" placeholder="Ejm: 0945685">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-xs-12">
